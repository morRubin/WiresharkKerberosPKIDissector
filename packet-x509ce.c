...
static int hf_x509ce_Pku2uSids_PDU = 0;  /* Pku2u Sids, Couldn't find it documented yet */
...
static gint ett_x509ce_Pku2uGroupSids = -1;
...
static int
dissect_x509ce_Pku2uGroupsSidsOctetString(gboolean implicit_tag _U_, tvbuff_t* tvb _U_, int offset _U_, asn1_ctx_t* actx _U_, proto_tree* tree _U_, int hf_index _U_) {
    offset = dissect_ber_octet_string(implicit_tag, actx, tree, tvb, offset, hf_index,
        NULL);
...
static const ber_sequence_t Pku2uGroupSids_sequence[] = {
  { &hf_x509ce_entrustVers  , BER_CLASS_UNI, BER_UNI_TAG_OCTETSTRING, BER_FLAGS_NOOWNTAG, dissect_x509ce_Pku2uGroupsSidsOctetString },
  { NULL, 0, 0, 0, NULL }
};

static int
dissect_x509ce_Pku2uGroupSids(gboolean implicit_tag _U_, tvbuff_t* tvb _U_, int offset _U_, asn1_ctx_t* actx _U_, proto_tree* tree _U_, int hf_index _U_) {
    /*offset = dissect_ber_sequence(implicit_tag, actx, tree, tvb, offset,
        Pku2uGroupSids_sequence, hf_index, ett_x509ce_Pku2uGroupSids);*/
...
static int dissect_Pku2uSids_PDU(tvbuff_t* tvb _U_, packet_info* pinfo _U_, proto_tree* tree _U_, void* data _U_) {
    int offset = 0;
    asn1_ctx_t asn1_ctx;
    asn1_ctx_init(&asn1_ctx, ASN1_ENC_BER, TRUE, pinfo);
    offset = dissect_x509ce_Pku2uGroupSids(FALSE, tvb, offset, &asn1_ctx, tree, hf_x509ce_Pku2uSids_PDU);
    return offset;
}
...
#line 1 "./asn1/x509ce/packet-x509ce-dis-tab.c"
  ...
  register_ber_oid_dissector("1.3.6.1.4.1.311.90.1", dissect_Pku2uSids_PDU, proto_x509ce, "");
